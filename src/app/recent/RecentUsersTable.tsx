...
export default function RecentUsersTable({ people }: { people: SimpleAccountData[] }) {
  let i = 1;

  return (
    <div className="bg-white py-10">
      <h2 className="px-4 text-base font-semibold leading-7 text-gray-900 sm:px-6 lg:px-8">Recently joined users</h2>
            ...
            <tr key={person.holderCount} className="hover:bg-gray-50">
              ...
              <td className="py-4 pl-4 pr-8 sm:pl-6 lg:pl-8">
                <div className="flex items-center gap-x-4">
                  ...
                  <Link href={`/${person.id}`}>
                    <div className="truncate text-sm font-medium leading-6 text-gray-900">{person.twitterName || person.id}</div>
                  </Link>
                </div>
              </td>
